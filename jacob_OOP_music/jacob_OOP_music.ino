...
class Music
{
    ...
    bool noteplaying;
  public:
    Music(int* melody2, int* noteduration2, int numnotes2, int pin)
    { previousmillis = 0;
    ...
    void Update()
    {
      ...
      if (!noteplaying && currentmillis - previousmillis >= interval) {
        ...
        interval = 1000 / noteduration[thisnote];
...
Music peppa_pig( melody, noteduration, 11, 11);
