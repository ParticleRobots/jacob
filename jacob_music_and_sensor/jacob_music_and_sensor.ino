...
void loop() {
  ...
  if (distance > 125) {
     digitalWrite(motor_left, LOW);//the motor will stop
    digitalWrite(motor_right, LOW);//the motor will stop
    servo.write(0);
      servo2.write(0);
      delay(100);
      servo.write(180);
    ...
    digitalWrite(motor_left, HIGH);//the motor will move forward
    digitalWrite(motor_right, HIGH);//the motor will move forward
    delay(500);
    //digitalWrite(motor_left, HIGH);//motor will stop
    //delay(500);
    Serial.print("distance: ");
    Serial.print(distance);
    Serial.println("cm");
    //digitalWrite(motor_right, LOW);//the motor will move forward
    //delay(500);
    //digitalWrite(motor_right, LOW);//motor will stop
    ///delay(500);
