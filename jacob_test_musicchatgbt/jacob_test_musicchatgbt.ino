...
// Music class to handle melody, note durations, and timing
class Music {
private:
  int* melody;
  int* noteDurations;
...
// Instantiate Music class for melody playback
Music peppaPig(melody, noteDurations, 11, 11);  // Pin 11 for tone
Music supermariobros(melody, noteDurations, 11, 12);
void setup() {
